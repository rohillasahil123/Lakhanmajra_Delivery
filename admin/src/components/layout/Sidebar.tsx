...
export default function Sidebar() {
  ...
  return (
    <aside
      style={{ width: 200, minHeight: "100vh", background: "#fff", borderRight: "1px solid #e8eaf0", display: "flex", flexDirection: "column", flexShrink: 0 }}
      className="dark:bg-slate-900 dark:border-slate-700"
    >
      {/* Logo */}
      <div style={{ padding: "16px 14px 14px", borderBottom: "1px solid #e8eaf0" }} className="dark:border-slate-700">
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          <div style={{ width: 30, height: 30, background: "#3b6ef8", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 2px 8px rgba(59,110,248,.3)" }}>
