...
export const SearchIcon: React.FC<IconProps> = ({ className = '', size = 13, strokeWidth = 2 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PlusIcon: React.FC<IconProps> = ({ className = '', size = 13, strokeWidth = 2.5 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ExportIcon: React.FC<IconProps> = ({ className = '', size = 12 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
