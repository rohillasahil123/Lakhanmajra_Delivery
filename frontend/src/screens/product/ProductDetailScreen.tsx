    ...
    async function load() {
      try {
        ...
        const defaultVariant =
          variants.find((v: ProductVariant) => v?.isDefault) || variants[0];

        setSelectedVariantId(
          defaultVariant?._id ? String(defaultVariant._id) : "",
        );
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.infoSection}>
          <ThemedText
            style={[styles.productName, { fontSize: isCompact ? 20 : 22 }]}
          >
            {product.name}
          </ThemedText>
            ...
            >
              <ThemedText
                style={[
                  ...
                  activeStock > 0
                    ? styles.stockChipTextIn
                    : styles.stockChipTextOut,
                ]}
              >
          ...
          <View style={[styles.priceRow, isCompact && styles.priceRowCompact]}>
            <View>
              <ThemedText
                style={[styles.price, { fontSize: isCompact ? 24 : 28 }]}
              >
                ₹{activePrice}
              </ThemedText>
