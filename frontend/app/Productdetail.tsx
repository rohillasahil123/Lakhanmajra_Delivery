      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View
          style={[
            ...
            { height: getResponsiveImageHeight(width, 0.62) },
          ]}
        >
          {PRODUCT_DETAIL.discount > 0 && (
            <View style={styles.discountBadge}>
              <ThemedText style={styles.discountText}>
                {PRODUCT_DETAIL.discount}% OFF
              </ThemedText>
            </View>
          )}
          <ThemedText
            style={[
              ...
              {
                fontSize: compact
                  ? responsiveModerateScale(110)
                  : responsiveModerateScale(140),
              },
            ]}
          >
        ...
        <View
          style={[styles.infoSection, { paddingHorizontal: screenPadding }]}
        >
          {/* Category */}
        ...
        style={[
          styles.bottomBar,
          {
            ...
            paddingBottom: Math.max(
              responsiveVerticalScale(14),
              insets.bottom + responsiveVerticalScale(8),
            ),
          },
        ]}
      >
